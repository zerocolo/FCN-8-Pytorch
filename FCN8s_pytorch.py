...
class FCN(nn.Module):
    ...
    def __init__(self):
        ...
        self.score_feat3 = nn.Conv2d(256, 1, 1)
        self.score_feat4 = nn.Conv2d(512, 1, 1)
        self.upscore = nn.ConvTranspose2d(1, 1, 16, stride=8,
                                              bias = False)
        self.upscore_4 = nn.ConvTranspose2d(1, 1, 4, stride=2,
                                              bias = False)
        self.upscore_5 = nn.ConvTranspose2d(1, 1, 4, stride=2,
                                              bias = False)
